...
def select_percentage(percentage = 100, 
    ...
    hoi_path = Path('/PATH/TO/hico_20160224_det')
...
if __name__ == '__main__':
    ...
    # hoi_noise_path = Path('/PATH/TO/hico_20160224_det') / 'annotations' / 'trainval_hico_30relation_noise.json'
    # hoi_path = Path('/PATH/TO/hico_20160224_det') / 'annotations' / 'trainval_hico.json'
    ...
    # Check:  100590
    # Successfully save to /PATH/TO/hico_20160224_det/annotations/trainval_hico_UO.json.
    # Hoi triplets before and after unseen filtering:  [117871, 117526]
    # Check:  117526
    # Successfully save to /PATH/TO/hico_20160224_det/annotations/trainval_hico_UC-RF.json.
