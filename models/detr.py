...
from .hoi import OCN, SeqDETRHOI, CDNHOI, SepDETRHOI, ParSe, SepDETRHOIv3, RLIP_ParSe, DDETRHOI, ParSeD, RLIP_ParSeD, ParSeDABDETR
...
def build(args):
    ...
    weight_dict = {}
    if args.hoi or args.RLIP_ParSe or args.RLIP_ParSeD:
    ...
    if args.hoi or args.RLIP_ParSe or args.RLIP_ParSeD:
        ...
        if args.HOICVAE:
            ...
            criterion = SetCriterionHOI(args.num_obj_classes, args.num_queries, args.num_verb_classes, matcher=matcher,
                                    ...
                                    matching_symmetric = args.matching_symmetric, ParSeDETRHOI = args.RLIP_ParSe, 
